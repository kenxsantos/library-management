  ...
  <div class="container">
    ...
    <form action="updateBook.php" method="post">
      ...
      <div class="form-group" style="display: none;" id="bookText">
        ...
        <input type="text" class="form-control" name="bookTextVal" id="bookTextVal" aria-describedby="helpId">
      ...
      <center> <button type="submit" onClick="javascript: return confirm('Are you sure you want to update this book?')"
          class="btn btn-primary" name="adminUpdateBook">Update Book</button>
    </form>
  </div>
