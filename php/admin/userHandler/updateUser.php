  ...
  <div class="container">
    <form action="updateUser.php" method="post">
      ...
      <div class="form-group" style="display: none;" id="userText">
        ...
        <input type="text" class="form-control" name="userTextVal" id="userTextVal" aria-describedby="helpId">
      ...
      <center> <button type="submit" onClick="javascript: return confirm('Are you sure you want to update this user?')"
          class="btn btn-primary" name="adminUpdateUser">Update User</button>
    </form>
  </div>
