  ...
  <div class="container">
    ...
    <form action="userEditProfile.php" method="post">
      ...
      <div class="form-group" id="editText">
        ...
        <input type="text" class="form-control" name="editTextVal" id="editTextVal" aria-describedby="helpId">
      ...
      <div class="form-group" style="display:none;" id="editPassword">
        ...
        <input type="password" class="form-control" name="editPasswordVal" id="editPasswordVal"
      ...
      <div class="form-group" style="display:none;" id="editPassword2">
        ...
        <input type="password" class="form-control" name="editPasswordVal2" id="editPasswordVal2"
          aria-describedby="helpId">
        <small id="helpId" class="form-text text-muted">Passwords must match</small>
      </div>


      <center><button type="submit" onClick="javascript: return confirm('Are you sure you want to edit this info?')"
          class="btn btn-primary" name="userEditInfo">Save Changes</button>
    </form>
  </div>
