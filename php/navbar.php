...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        if (isset($_SESSION["username"])) {
            echo "<a class='navbar-brand' href='http://localhost:80/LibraryManager-master/php/homeAuthUser.php'>TIP Library</a>";
        } else {
            echo "<a class='navbar-brand' href='http://localhost:80/LibraryManager-master/php/home.php'>TIP Library</a>";
        }
        ?>
